...
There are several ways you can bring up an issue to the TOC. The most direct one is to simply open an issue in [the TOC GitHub repository](https://github.com/Green-Software-Foundation/toc/issues) or to send an email to [the TOC mailing list](toc@greensoftware.foundation). 
...
If you are unsure about how to proceed or would like to raise an issue privately consider contacting one of the [TOC members](./toc-members.md). 
