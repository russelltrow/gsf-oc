...
-   [`LICENSE`](https://www.apache.org/licenses/LICENSE-2.0.txt) - https://www.apache.org/licenses/LICENSE-2.0.txt\
    (Unless an exception has been made by the Green Software Foundation Governing Board)
...
-   Apache License Header information in each source code file. \
    For new files added to Green Software Foundation repositories they SHOULD include the snippet `SPDX-License-Identifier: Apache-2.0` as part of the header. 
...
[Green Software Foundation Community Management Tools](https://github.com/hyperledger-labs/hyperledger-community-management-tools/tree/main/repo_structure).
