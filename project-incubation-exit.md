...
Green Software Foundation has defined a [lifecycle](./project-lifecycle.md) for its
...
in a [Proposal for a Green Software Foundation Improvement Project (HIP)](https://hyperledger.github.io/hyperledger-hip/)
...
-   Alignment
    ...
    -   Architecture
        ...
        The project must document how it fits within the [Green Software Foundation Architecture](https://wiki.hyperledger.org/display/AWG)
    ...
    -   Release numbering: the project should use the Green Software Foundation
...
-   Security
    ...
    -   Participate in Green Software Foundation wide security discussions.
